...
/**
 * <p>addInallsaleResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="addInallsaleResponse">
 *   &lt;complexContent>
...
@XmlType(name = "addInallsaleResponse", propOrder = {
    "_return"
})
public class AddInallsaleResponse {
