...
public class PassengerVo implements Serializable {
	...
	public String toString() {
		return "PassengerVo{" +
				...
				", saleFareTax='" + saleFareTax + '\'' +
				", buyFareTax='" + buyFareTax + '\'' +
				", saleTax=" + saleTax +
				", saleBrokerage=" + saleBrokerage +
				", buyBrokerage=" + buyBrokerage +
				", saleAgencyFeeRebate='" + saleAgencyFeeRebate + '\'' +
				", buyAgencyFeeRebate='" + buyAgencyFeeRebate + '\'' +
				...
				", saleAirlineCount=" + saleAirlineCount +
				", buyAirlineCount=" + buyAirlineCount +
