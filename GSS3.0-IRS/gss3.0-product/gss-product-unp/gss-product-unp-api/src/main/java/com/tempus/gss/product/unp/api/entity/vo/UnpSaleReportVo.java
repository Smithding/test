...
public class UnpSaleReportVo implements Serializable {
    ...
    public String toString() {
        return "UnpSaleReportVo:{ " + "\"saleOrderNo\":" + (saleOrderNo == null ? null : "\"" + saleOrderNo + "\"") + ",\"customerName\":" + (customerName == null ? "\"\"" : "\"" + customerName + "\"") + ",\"supplierName\":" + (supplierName == null ? "\"\"" : "\"" + supplierName + "\"") + ",\"source\":" + (source == null ? "\"\"" : "\"" + source + "\"") + ",\"productName\":" + (productName == null ? "\"\"" : "\"" + productName + "\"") + ",\"itemStuts\":" + (itemStuts == null ? null : "\"" + itemStuts + "\"") + ",\"companyName\":" + (companyName == null ? "\"\"" : "\"" + companyName + "\"") + ",\"deptName\":" + (deptName == null ? "\"\"" : "\"" + deptName + "\"") + ",\"createTime\":" + (createTime == null ? null : "\"" + createTime + "\"") + ",\"salePlanAmount\":" + (salePlanAmount == null ? null : "\"" + salePlanAmount + "\"") + ",\"saleActualAmount\":" + (saleActualAmount == null ? null : "\"" + saleActualAmount + "\"") + ",\"buyPlanAmount\":" + (buyPlanAmount == null ? null : "\"" + buyPlanAmount + "\"") + ",\"additionalInfo\":" + (additionalInfo == null ? "\"\"" : "\"" + additionalInfo + "\"") + "}";
    }
}
